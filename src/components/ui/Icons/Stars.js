...
export const HalfStar = withTheme(props => (
  <svg viewBox='0 0 512 512' fill={props.theme.text} {...props}>
...
export const EmptyStar = withTheme(props => (
  <svg viewBox='0 0 512 512' fill={props.theme.text} {...props}>
...
export const FilledStar = withTheme(props => (
  <svg viewBox='0 0 512 512' fill={props.theme.text} {...props}>
